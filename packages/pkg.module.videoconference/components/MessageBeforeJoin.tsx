...
export function MessageBeforeJoin({ typeOfMessage }: IMessageBeforeJoin) {
  return (
    <div className="mb-4">
      ...
      {typeOfMessage === 'needPermission' && (
        <div className="bg-orange-0 mb-4 rounded-md p-4 font-sans">
          <div className="flex items-center gap-5">
            <div className="bg-orange-80 rounded-full fill-white p-2">
              <Microphone className="fill-white" width={16} />
            </div>
            <div>
