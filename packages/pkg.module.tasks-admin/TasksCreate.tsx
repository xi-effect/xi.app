  ...
  return (
    <div className="flex h-full flex-col md:h-[100dvh] lg:p-0">
      ...
      <div className="flex flex-col justify-between px-4 lg:flex-row lg:px-8">
        <div className="border-gray-30 flex h-[776px] w-full flex-col rounded-xl border-[1px] pl-14 pt-14 lg:h-full lg:w-[966px] lg:flex-auto 2xl:border-none 2xl:pl-0 2xl:pt-0">
