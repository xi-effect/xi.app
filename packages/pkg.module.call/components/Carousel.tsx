    ...
    <div className="relative h-full overflow-hidden">
      ...
      >
        <button
          ...
          onClick={handlePrev}
          className="disabled:fill-gray-80 fill-gray-100 z-10 bg-transparent p-0 text-center hover:opacity-100 disabled:cursor-not-allowed"
        >
          <div className="flex items-center justify-center rounded-full bg-gray-0 p-2">
